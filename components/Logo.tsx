  ...
  return (
    <div className={`w-[24px] h-[24px] text-[var(--text-primary)] flex items-center justify-center overflow-hidden shrink-0 ${className ?? ""}`}>
      <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <rect x="4.00781" y="5.53418" width="4.06272" height="1.68113" transform="rotate(15 4.00781 5.53418)" fill="currentColor"/>
      </svg>
    </div>
  );
}
